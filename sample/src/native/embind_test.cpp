// https://raw.githubusercontent.com/emscripten-core/emscripten/7d291a7660cbf678dac9988dda7b898570ba4ed0/test/embind/embind_test.cpp
...
EMSCRIPTEN_BINDINGS(optionalMethod) {
...
EMSCRIPTEN_BINDINGS(tests) {
        // register_vector<int>("IntegerVectorTest");
        // register_vector<char>("CharVectorTest");
        // register_vector<unsigned>("VectorUnsignedTest");
        // register_vector<unsigned char>("VectorUnsignedCharTest");
        // register_vector<std::string>("StringVectorTest");
        register_vector<emscripten::val>("EmValVectorTest");
        // register_vector<float>("FloatVectorTest");
        register_vector<std::vector<int>>("IntegerVectorVectorTest");
